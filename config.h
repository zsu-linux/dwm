...
static const char *fonts[]          = { "Source Code Pro:size=19:type=Regular:antialias=true:autohint=true",
																			  "Fira Code Nerd Font Mono:size=28:type=Regular:antialias=true:autohint=true",
                                        "WenQuanYi Micro Hei:size=16:type=Regular:antialias=true:autohint=true"};
static const char dmenufont[]       = "Fira Code Nerd Font:size=19:type=Regular:antialias=true:autohint=true";
